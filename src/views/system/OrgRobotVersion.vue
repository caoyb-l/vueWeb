...
import EditForm from './modules/EditOrgRobotApp'
import CreateForm from './modules/AddOrgRobotApp'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return queryData(Object.assign(parameter, this.queryParam, { orgId: orgId }), '/OrgRobotVersion/queryOrgRobotVersion')
          .then(res => {
            console.log(res)
            return res.result
          })
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          return new Promise((resolve, reject) => {
            ...
            queryData(param, '/OrgRobotVersion/delOrgRobotVersionMsg').then(res => {
