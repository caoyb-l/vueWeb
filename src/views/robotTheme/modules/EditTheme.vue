  ...
  >
    <a-form :form="form">
      ...
      <a-form-item label="模版名称" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-input
          v-decorator="['name', { rules: [{ required: true, message: '名称' }], initialValue: createData.name }]"
          placeholder="名称"
        />
      </a-form-item>
      <!-- 版本号 -->
      <a-form-item label="机器人版本号" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-input
          v-decorator="[
            'robot_Version',
            { rules: [{ required: true, message: '版本号' }], initialValue: createData.robot_Version }
          ]"
          placeholder="使用的版本"
        />
      </a-form-item>
      ...
      <a-form-item label="内容区显示地址" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-input
          v-decorator="[
            'content_Area',
            { rules: [{ required: true, message: '内容区地址' }], initialValue: createData.content_Area }
          ]"
          placeholder="网页地址"
        />
      </a-form-item>
      ...
      <a-form-item label="内容区背景色" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <colorPicker
          style="z-index:206"
          v-decorator="[
            'content_Area_Background_Colour',
            {
              rules: [{ required: true, message: '选择一个颜色' }],
              initialValue: createData.content_Area_Background_Colour
            }
          ]"
          defaultColor="#FF0000"
        />
      ...
      <a-form-item label="对话区背景色" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <colorPicker
          ...
          v-decorator="[
            ...
            { rules: [{ required: true, message: '选择一个颜色' }], initialValue: createData.chat_Background_Colour }
          ]"
          defaultColor="#FF7D00"
        />
      </a-form-item>
      ...
      <a-form-item label="机器人对话气泡背景色" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <colorPicker
          ...
          v-decorator="[
            'robot_Text_Colour',
            { rules: [{ required: true, message: '选择一个颜色' }], initialValue: createData.robot_Text_Colour }
          ]"
          defaultColor="#FFFF00"
        />
      </a-form-item>
      ...
      <a-form-item label="机器人对话文字背景色" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <colorPicker
          style="z-index:203"
          v-decorator="[
            'robot_Text_Background_Colour',
            {
              rules: [{ required: true, message: '选择一个颜色' }],
              initialValue: createData.robot_Text_Background_Colour
            }
          ]"
          defaultColor="#00FF00"
        />
      ...
      <a-form-item label="客户对话气泡背景色" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <colorPicker
          ...
          v-decorator="[
            'client_Text_Colour',
            { rules: [{ required: true, message: '选择一个颜色' }], initialValue: createData.client_Text_Colour }
          ]"
          defaultColor="#00FFFF"
        />
      </a-form-item>
      ...
      <a-form-item label="客户对话文字背景色" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <colorPicker
          style="z-index:201"
          v-decorator="[
            'client_Text_Background_Colour',
            {
              rules: [{ required: true, message: '选择一个颜色' }],
              initialValue: createData.client_Text_Background_Colour
            }
          ]"
          defaultColor="#0000FF"
          width="300px"
      ...
      <a-form-item label="开机图片" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.boot_Screen_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.boot_Screen }
          ]"
        >
      ...
      <a-form-item label="休息、待机图片" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.standby_Screen_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.standby_Screen }
          ]"
        >
      ...
      <a-form-item label="logo" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.robot_Logo_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.robot_Logo }
          ]"
        >
      ...
      <a-form-item label="内容区图片" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.content_Area_Background_Picture_FileName',
            {
              rules: [{ required: true, message: '请上传文件' }],
              initialValue: createData.content_Area_Background_Picture
            }
          ]"
        >
        ...
        <a-modal
          :visible="createData.content_Area_Background_Picture_Visible"
          :footer="null"
          @cancel="content_Area_Background_Picture_Cancel"
        >
      ...
      <a-form-item label="聊天背景图片" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.chat_Background_Picture_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.chat_Background_Picture }
          ]"
        >
        ...
        <a-modal
          :visible="createData.chat_Background_Picture_Visible"
          :footer="null"
          @cancel="chat_Background_Picture_Cancel"
        >
      ...
      <a-form-item label="机器人对话气泡头像" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.robot_Head_Portrait_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.robot_Head_Portrait }
          ]"
        >
      ...
      >
        <a-upload
          ...
          v-decorator="[
            'createData.robot_Text_Picture_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.robot_Text_Picture }
          ]"
        >
      ...
      <a-form-item label="客户对话气泡头像" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.client_Head_Portrait_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.client_Head_Portrait }
          ]"
        >
        ...
        <a-modal
          :visible="createData.client_Head_Portrait_Visible"
          :footer="null"
          @cancel="client_Head_Portrait_Cancel"
        >
      ...
      <a-form-item label="客户对话区文字背景图" :labelCol="labelCol" :wrapperCol="wrapperCol" style="margin-bottom:0px">
        <a-upload
          ...
          v-decorator="[
            'createData.client_Text_Picture_FileName',
            { rules: [{ required: true, message: '请上传文件' }], initialValue: createData.client_Text_Picture }
          ]"
        >
...
export default {
  ...
  methods: {
    edit(record) {
      ...
      this.visible = true
      this.createData.entityId = record.id
      this.createData.name = record.name
      this.createData.robot_Version = record.robot_Version
      this.createData.content_Area = record.content_Area
      this.createData.chat_Background_Colour = record.chat_Background_Colour
      this.createData.client_Text_Background_Colour = record.client_Text_Background_Colour
      this.createData.client_Text_Colour = record.client_Text_Colour
      this.createData.content_Area_Background_Colour = record.content_Area_Background_Colour
      this.createData.robot_Text_Background_Colour = record.robot_Text_Background_Colour
      this.createData.robot_Text_Colour = record.robot_Text_Colour

      this.createData.boot_Screen = record.boot_Screen_Arr
      this.createData.boot_Screen_FileName = record.boot_Screen
      this.createData.standby_Screen = record.standby_Screen_Arr
      this.createData.standby_Screen_FileName = record.standby_Screen
      this.createData.robot_Logo = record.robot_Logo_Arr
      this.createData.robot_Logo_FileName = record.robot_Logo
      this.createData.content_Area_Background_Picture = record.content_Area_Background_Picture_Arr
      this.createData.content_Area_Background_Picture_FileName = record.content_Area_Background_Picture
      this.createData.chat_Background_Picture = record.chat_Background_Picture_Arr
      this.createData.chat_Background_Picture_FileName = record.chat_Background_Picture
      this.createData.robot_Head_Portrait = record.robot_Head_Portrait_Arr
      this.createData.robot_Head_Portrait_FileName = record.robot_Head_Portrait
      this.createData.robot_Text_Picture = record.robot_Text_Picture_Arr
      this.createData.robot_Text_Picture_FileName = record.robot_Text_Picture
      this.createData.client_Head_Portrait = record.client_Head_Portrait_Arr
      this.createData.client_Head_Portrait_FileName = record.client_Head_Portrait
      this.createData.client_Text_Picture = record.client_Text_Picture_Arr
      this.createData.client_Text_Picture_FileName = record.client_Text_Picture
    ...
    handleSubmit() {
      ...
      validateFields((errors, values) => {
        if (!errors) {
          ...
          queryData({ ...param, ...values }, '/robotTheme/save').then(res => {
            if (res.code == 0) {
    ...
    handleRemoveFile(file) {
      console.log(file);
      let _this = this
      const fileName = "createData."+[file.uid]//拼接参数
      queryData({ fileName: file.name }, '/robotTheme/delFile').then(res => {
        if (res.code == 0) {
          _this.$message.success(res.message)
          _this.form.setFieldsValue({[fileName]:''})//滞空form表单默认值
          return true
        } else {
          _this.$message.error(res.message)
          return false
      ...
      if (fileList.length > 0) {
        if (fileList[0].status == 'done') {
          ...
          if (res.code == 0) {
            ...
            _this.form.setFieldsValue({boot_Screen_FileName:null})
            _this.$message.success(`${res.fileName} 上传成功`)
          } else {
            _this.$message.error(res.message)
          }
        }
