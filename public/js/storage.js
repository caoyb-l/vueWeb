...
// Create a namespace.
var BlocklyStorage = {};
var storageURL="http://robot.lovechuangchuang.com:8084/storage";
// var storageURL="http://47.105.129.17:3000/storage";
var loadURL="http://robot.lovechuangchuang.com:8084/load";
// var loadURL="http://47.105.129.17:3000/load";
/**
 ...
 * @param {Blockly.WorkspaceSvg=} opt_workspace Workspace.
 */
BlocklyStorage.link = function(fileName,opt_workspace) {
  var workspace = opt_workspace || Blockly.getMainWorkspace();
  var xml = Blockly.Xml.workspaceToDom(workspace);
  var data = Blockly.Xml.domToText(xml);
  BlocklyStorage.makeRequest_(storageURL, 'xml', {data,fileName}, workspace);
};
...
BlocklyStorage.retrieveXml = function(key, opt_workspace) {
  var workspace = opt_workspace || Blockly.getMainWorkspace();
  BlocklyStorage.makeRequest_(loadURL, 'key', key, workspace);
};
