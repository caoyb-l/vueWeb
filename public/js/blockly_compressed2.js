...
goog.base = function(a, b, c) {
    ...
    f = !1;
    for (var g = a.constructor; g; g = g.superClass_ && g.superClass_.constructor) if (g.prototype[b] === d) f = !0;
    ...
    if (b) {
        var c = function(a) {
            if (! (a in f.written || a in f.visited)) {
                f.visited[a] = !0;
                if (a in f.requires) for (var b in f.requires[a]) if (!g.isProvided(b)) if (b in f.nameToPath) c(f.nameToPath[b]);
...
goog.DebugLoader.prototype.importScript_ = function(a, b) { (goog.global.CLOSURE_IMPORT_SCRIPT || goog.bind(this.writeScriptTag_, this))(a, b) && (this.dependencies_.written[a] = !0)
},
...
goog.debug.getStacktraceSimple = function(a) {
    ...
    b = [];
    for (var c = arguments.callee.caller,
    d = 0; c && (!a || d < a);) {
...
goog.events.listen_ = function(a, b, c, d, e, f) {
    ...
    d.src = a;
    d.listener = c;
    if (a.addEventListener) goog.events.BrowserFeature.PASSIVE_EVENTS || (e = g),
    void 0 === e && (e = !1),
    a.addEventListener(b.toString(), d, e);
    else if (a.attachEvent) a.attachEvent(goog.events.getOnString_(b.toString()), d);
    else if (a.addListener && a.removeListener) goog.asserts.assert("change" === b, "MediaQueryList only has a change event"),
    a.addListener(d);
...
goog.html.SAFE_URL_PATTERN_ = /^(?:(?:https?|mailto|ftp):|[^:/ ? #] * ( ? :[/?#]|$))/i; goog.html.SafeUrl.sanitize = function(a) {
...
}; goog.html.SafeStyle.prototype.implementsGoogStringTypedString = !0; goog.html.SafeStyle.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ = {}; goog.html.SafeStyle.fromConstant = function(a) {
    a = goog.string.Const.unwrap(a);
    ...
    return this
}; goog.html.SafeStyle.EMPTY = goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(""); goog.html.SafeStyle.INNOCUOUS_STRING = "zClosurez"; goog.html.SafeStyle.create = function(a) {
    var b = "",
    c;
    for (c in a) {
    ...
    return b && c
}; goog.html.SafeStyle.VALUE_ALLOWED_CHARS_ = "[-,.\"'%_!# a-zA-Z0-9]"; goog.html.SafeStyle.VALUE_RE_ = new RegExp("^" + goog.html.SafeStyle.VALUE_ALLOWED_CHARS_ + "+$"); goog.html.SafeUrl.URL_RE_ = RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))", "g"); goog.html.SafeUrl.FUNCTIONS_RE_ = RegExp("\\b(hsl|hsla|rgb|rgba|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-0-9a-z.%, ]+\\)", "g"); goog.html.SafeStyle.sanitizeUrl_ = function(a) {
    return a.replace(goog.html.SafeUrl.URL_RE_,
    function(a, c, d, e) {
        var b = "";
        d = d.replace(/^(['"])(.*)\1$/,
        function(a, c, d) {
...
}; goog.html.SafeStyleSheet.prototype.implementsGoogStringTypedString = !0; goog.html.SafeStyleSheet.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ = {}; goog.html.SafeStyleSheet.createRule = function(a, b) {
    ...
    return this
}; goog.html.SafeStyleSheet.EMPTY = goog.html.SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(""); goog.html.SafeHtml = function() {
    this.privateDoNotAccessOrElseSafeHtmlWrappedValue_ = "";
    ...
    a = [a];
    for (var d = 0,
    e = null; 0 < a.length && d < b;) if (e = a.pop(), !(e.nodeName in goog.dom.TAGS_TO_IGNORE_)) if (e.nodeType == goog.dom.NodeType.TEXT) {
    ...
    d = c.getDocument();
    if (goog.userAgent.IE && d.createStyleSheet) return c = d.createStyleSheet(),
    ...
    else if (d = goog.isObject(d) ? !!d.capture: !!d, a = goog.events.getListener(a, b, c || this.handleEvent, d, e || this.handler_ || this)) goog.events.unlistenByKey(a),
...
}; goog.debug.Logger.ROOT_LOGGER_NAME = ""; goog.debug.Logger.ENABLE_HIERARCHY = !0; goog.debug.Logger.ENABLE_PROFILER_LOGGING = !1; goog.debug.Logger.ENABLE_HIERARCHY || (goog.debug.Logger.rootHandlers_ = []); goog.debug.Logger.Level = function(a, b) {
    this.name = a;
    this.value = b
...
var Blockly = {}; Blockly.Blocks = Object(null); Blockly.Touch = {}; Blockly.Touch.touchIdentifier_ = null; Blockly.Touch.TOUCH_MAP = {}; goog.events.BrowserFeature.TOUCH_ENABLED && (Blockly.Touch.TOUCH_MAP = {
    ...
    if (!goog.array.remove(this.topBlocks_, a)) console.log( "Block not present in workspace's list of top-most blocks.");
    return false;
    ...
    c = this.getAllBlocks();
    for (var e = 0; e < c.length; e++) c[e].renameVar(a.name, b),
    d && c[e].renameVar(d, b);
    ...
    var e = this,
    f = e.getVariable(a);
    1 < b.length ? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace("%1", String(b.length)).replace("%2", a),
    function(a) {
...
}; Blockly.Extensions = {}; Blockly.Extensions.ALL_ = {}; Blockly.Extensions.register = function(a, b) {
    ...
    e && this.closestConnection_ && (this.closestConnection_.unhighlight(), this.closestConnection_ = null); ! this.wouldDeleteBlock_ && d && this.closestConnection_ && this.addHighlighting_()
...
}; Blockly.utils = {}; Blockly.utils.getMessageArray_ = function() {
    ...
    for (var b = !0,
    c = Blockly.utils.getMessageArray_(), d = /%{(BKY_[A-Z][A-Z0-9_]*)}/gi, e = d.exec(a); e;) {
        var f = e[1];
        f = f.toUpperCase();
    ...
    d = 0;
    for (var e; e = a.inputList[d]; d++) for (var f = 0,
    g; g = e.fieldRow[f]; f++) {
        var h = g;
    ...
    if (d = a.getCommentText()) d = goog.dom.createDom("comment", null, d),
    "object" == typeof a.comment && (d.setAttribute("pinned", a.comment.isVisible()), e = a.comment.getBubbleSize(), d.setAttribute("h", e.height), d.setAttribute("w", e.width)),
    c.appendChild(d);
    ...
    if (d = a.getNextBlock()) k = goog.dom.createDom("next", null, Blockly.Xml.blockToDom(d, b)),
    c.appendChild(k);
    f = a.nextConnection && a.nextConnection.getShadowDom(); ! f || d && d.isShadow() || k.appendChild(Blockly.Xml.cloneShadow_(f));
    return c
    ...
    try {
        for (var h = 0; h < e; h++) {
            ...
            if ("block" == n || "shadow" == n && !Blockly.Events.recordUndo) {
                ...
                g = !1
            } else if ("shadow" == n) goog.asserts.fail("Shadow block cannot be a top-level block."),
            g = !1;
            else if ("variables" == n) {
    ...
    for (var f = null,
    g = 0,
    h; h = a.childNodes[g]; g++) if (3 != h.nodeType) {
        var k = null,
        n = null;
        f = 0;
        for (var p; p = h.childNodes[f]; f++) 1 == p.nodeType && ("block" == p.nodeName.toLowerCase() ? k = p: "shadow" == p.nodeName.toLowerCase() && (n = p)); ! k && n && (k = n);
        ...
        case "next":
            ...
            k && (goog.asserts.assert(c.nextConnection, "Next statement does not exist."), goog.asserts.assert(!c.nextConnection, "Next statement is already connected."), f = Blockly.Xml.domToBlockHeadless_(k, b), goog.asserts.assert(f.previousConnection, "Next block does not have previous statement."), c.nextConnection.connect(f.previousConnection));
            break;
        default:
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        ...
        if (this.options.collapse) {
            for (var k = h = !1,
            n = 0; n < e.length; n++) for (var p = e[n]; p;) p.isCollapsed() ? h = !0 : k = !0,
            p = p.getNextBlock();
            var l = function(a) {
                for (var b = 0,
        ...
        h = {
            ...
            callback: function() {
                ...
                2 > m.length ? c() : Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", m.length),
                function(a) {
                    a && c()
                })
            }
    ...
    if (this.toolbox_) if (this.toolboxPosition == Blockly.TOOLBOX_AT_TOP || this.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM) c.height -= a.height;
    ...
    return a.newBlock(b)
}; Blockly.Block.prototype.data = null; Blockly.Block.prototype.colour_ = "#000000"; Blockly.Block.prototype.hue_ = null; Blockly.Block.prototype.dispose = function(a) {
    if (this.workspace) {
    ...
    var b = Number(a);
    if (!isNaN(b) && 0 <= b && 360 >= b) this.hue_ = b,
    this.colour_ = Blockly.hueToRgb(b);
    else if (goog.isString(a) && /^#[0-9a-fA-F]{6}$/.test(a)) this.colour_ = a,
    this.hue_ = null;
    ...
    b = [];
    for (g = 0; g < a.length; g++) if (e = a[g], "string" == typeof e) b.push([e, void 0]);
    else {
        d = f = null;
        do
...
}; Blockly.Block.prototype.setWarningText = function(a, b) {}; Blockly.Block.prototype.setMutator = function(a) {}; Blockly.Block.prototype.getRelativeToSurfaceXY = function() {
    return this.xy_
...
}; Blockly.utils.uiMenu = {}; Blockly.utils.uiMenu.getSize = function(a) {
    a = a.getElement();
...
}; goog.inherits(Blockly.BlockSvg, Blockly.Block); Blockly.BlockSvg.prototype.height = 0; Blockly.BlockSvg.prototype.width = 0; Blockly.BlockSvg.prototype.dragStartXY_ = null; Blockly.BlockSvg.prototype.warningTextDb_ = null; Blockly.BlockSvg.INLINE = -1; Blockly.BlockSvg.prototype.initSvg = function() {
    ...
    for (var a = [], b = 0, c; c = this.inputList[b]; b++) {
        for (var d = 0,
        e; e = c.fieldRow[d]; d++) e instanceof Blockly.FieldTextInput && a.push(e);
    ...
    else for (var d in this.warningTextDb_) clearTimeout(this.warningTextDb_[d]),
    ...
    h = !1,
    k = void 0,
    n = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++) if (l.isVisible()) {
        if (n && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT) var m = c[c.length - 1];
        else k = l.type,
        m = [],
        m.type = n && l.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE: l.type,
        m.height = 0,
        c.push(m);
        m.push(l);
    ...
    for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++) if (!g.isNull()) {
        ...
        k = e[h];
        k ? g.type == Blockly.Events.MOVE ? (k.newParentId = g.newParentId, k.newInputName = g.newInputName, k.newCoordinate = g.newCoordinate) : g.type == Blockly.Events.CHANGE && g.element == k.element && g.name == k.name ? k.newValue = g.newValue: g.type != Blockly.Events.UI || "click" != g.element || "commentOpen" != k.element && "mutatorOpen" != k.element && "warningOpen" != k.element ? (e[h] = g, d.push(g)) : k.newValue = g.newValue: (e[h] = g, d.push(g))
    }
...
}; goog.inherits(Blockly.FieldTextInput, Blockly.Field); Blockly.FieldTextInput.FONTSIZE = 11; Blockly.FieldTextInput.htmlInput_ = null; Blockly.FieldTextInput.prototype.CURSOR = "text"; Blockly.FieldTextInput.prototype.spellcheck_ = !0; Blockly.FieldTextInput.prototype.dispose = function() {
    ...
    a = a || !1; ! a && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD) ? this.showPromptEditor_() : this.showInlineEditor_(a)
    ...
    var e = this;
    Blockly.FieldColour.changeEventKey_ = goog.events.listen(c, goog.ui.ColorPicker.EventType.CHANGE,
    function(a) {
    ...
    var b = this;
    goog.events.listen(a, goog.ui.Component.EventType.ACTION,
    function(a) {
    ...
    a.getHandler().listen(a.getElement(), goog.events.EventType.TOUCHSTART,
    function(a) {
        this.getOwnerControl(a.target).handleMouseDown(a)
    })
}; Blockly.FieldDropdown.prototype.addTouchEndListener_ = function(a) {
    a.getHandler().listen(a.getElement(), goog.events.EventType.TOUCHEND,
    function(a) {
    ...
    if (goog.isArray(a)) {
        ...
        if (! (b || 2 > a.length)) {
            ...
            var e = Blockly.utils.commonWordSuffix(b, c); ! d && !e || c <= d + e || (d && (this.prefixField = b[0].substring(0, d - 1)), e && (this.suffixField = b[0].substr(1 - e)), this.menuGenerator_ = Blockly.FieldDropdown.applyTrim_(a, d, e))
        }
    }
    ...
    null !== a && (this.text_ = a)
}; Blockly.FieldImage.prototype.render_ = function() {}; Blockly.FieldImage.prototype.updateWidth = function() {}; Blockly.FieldImage.prototype.showEditor_ = function() {
    ...
    this.workspace_.scale = this.targetWorkspace_.scale;
    for (var a = 0,
    b = this.workspace_.getTopBlocks(!1), c = 0, d; d = b[c]; c++) a = Math.max(a, d.getHeightWidth().height);
    a += 1.5 * this.MARGIN;
    ...
    this.workspace_.scale = this.targetWorkspace_.scale;
    for (var a = 0,
    b = this.workspace_.getTopBlocks(!1), c = 0, d; d = b[c]; c++) {
    ...
    a += Blockly.Scrollbar.scrollbarThickness;
    if (this.width_ != a) {
        for (c = 0; d = b[c]; c++) this.RTL && (e = d.getRelativeToSurfaceXY().x, d.moveBy(a / this.workspace_.scale - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH - e, 0)),
        d.flyoutRect_ && this.moveRectToBlock_(d.flyoutRect_, d);
        if (this.RTL) for (c = 0; d = this.buttons_[c]; c++) b = d.getPosition().y,
        d.moveTo(a - d.width - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH, b);
        this.width_ = a;
        this.targetWorkspace_.resize()
    }
    ...
    case "CATEGORY":
        ...
        goog.isString(h) ? (/^#[0-9a-fA-F]{6}$/.test(h) ? e.hexColour = h: e.hexColour = Blockly.hueToRgb(Number(h)), this.hasColours_ = !0) : e.hexColour = "";
    ...
    this.updateRow()
}; Blockly.Toolbox.TreeNode.prototype.onMouseDown = function(a) {}; Blockly.Toolbox.TreeNode.prototype.onDoubleClick_ = function(a) {}; Blockly.Toolbox.TreeNode.prototype.onKeyDown = function(a) {
...
Blockly.WidgetDiv = {}; Blockly.WidgetDiv.DIV = null; Blockly.WidgetDiv.owner_ = null; Blockly.WidgetDiv.dispose_ = null; Blockly.WidgetDiv.createDom = function() {
    ...
    if (d) return b = Math.max(b.right - c.width, a.left),
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function() {
        if (!e.isDragging()) {
            ...
            if (a.contentTop < d || a.contentTop + a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft: c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth: a.viewWidth + c)) for (var k = e.getTopBlocks(!1), n = 0, p; p = k[n]; n++) {
...
var CLOSURE_DEFINES = {
    ...
    h = function(a) {
        ...
        for (var f = 0,
        h; h = a[f]; f++) if (!b || Blockly.Touch.shouldHandleEvent(h)) Blockly.Touch.setClientFromTouch(h),
        c ? d.call(c, h) : d(h),
        g = !0
    };
    ...
    p = 0, l; l = Blockly.Touch.TOUCH_MAP[b][p]; p++) a.addEventListener(l, n, !1),
    k.push([a, l, n]);
    return k
