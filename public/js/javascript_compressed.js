...
Blockly.JavaScript.procedures_defreturn = function(a) {
  ...
  if (Blockly.JavaScript.STATEMENT_PREFIX) {
    ...
    c =
      Blockly.JavaScript.prefixLines(
        Blockly.JavaScript.STATEMENT_PREFIX.replace(/%1/g, "'" + d + "'"),
  ...
  (d =
    Blockly.JavaScript.valueToCode(
      ...
      "RETURN",
      Blockly.JavaScript.ORDER_NONE
    ) || "") && (d = Blockly.JavaScript.INDENT + "return " + d + ";\n");
...
Blockly.JavaScript.text_count = function(a) {
  ...
  a =
    Blockly.JavaScript.valueToCode(a, "SUB", Blockly.JavaScript.ORDER_NONE) ||
    "''";
  return [
    Blockly.JavaScript.provideFunction_("textCount", [
      "function " +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
        "(haystack, needle) {",
      "  if (needle.length === 0) {",
...
Blockly.JavaScript.text_replace = function(a) {
  ...
  a =
    Blockly.JavaScript.valueToCode(a, "TO", Blockly.JavaScript.ORDER_NONE) ||
    "''";
  return [
    Blockly.JavaScript.provideFunction_("textReplace", [
      "function " +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
